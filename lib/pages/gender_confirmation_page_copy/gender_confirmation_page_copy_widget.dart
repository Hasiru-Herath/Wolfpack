...
import 'gender_confirmation_page_copy_model.dart';
...
class GenderConfirmationPageCopyWidget extends StatefulWidget {
  ...
  State<GenderConfirmationPageCopyWidget> createState() =>
      _GenderConfirmationPageCopyWidgetState();
}

class _GenderConfirmationPageCopyWidgetState
    extends State<GenderConfirmationPageCopyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GenderConfirmationPageCopyModel());
  }
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 0.0),
                            child: Text(
                              'Tell us your preferences so we can set \nyou up with people you’ll click with.',
